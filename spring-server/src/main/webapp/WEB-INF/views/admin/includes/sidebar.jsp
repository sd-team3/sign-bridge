...
<aside class="sidebar" id="sidebar">
  ...
  <nav class="sidebar-nav">
    <div class="nav-group">
      ...
      <a class="nav-item ${activeMenu == 'dashboard' ? 'active' : ''}" href="${pageContext.request.contextPath}/admin/main">
    ...
    <div class="nav-group">
      ...
      <a class="nav-item ${activeMenu == 'question-error' ? 'active' : ''}" href="${pageContext.request.contextPath}/admin/inquiry">
