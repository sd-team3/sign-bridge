...
<div class="main">
  ...
  <div class="topbar">
    <div style="display:flex;align-items:center;gap:12px">
      <button id="menu-toggle" style="display:none;background:none;border:none;font-size:20px;cursor:pointer">☰</button>
    ...
    <div class="topbar-right">
      <button class="topbar-btn btn-ghost" id="refresh-btn">↻ 새로고침</button>
      <a href="/" class="topbar-btn btn-ghost">← 사이트로</a>
    </div>
  </div>
